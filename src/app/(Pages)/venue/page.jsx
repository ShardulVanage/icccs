...
export default function VenuePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-50 dark:from-blue-900 dark:to-blue-900 text-foreground">
      <motion.section
        initial="hidden"
        animate="visible"
        variants={fadeIn}
      ...
      >
        <div className="flex flex-col md:flex-row justify-center items-center gap-8">
          ...
          <div className="w-full md:w-1/2">
            <h1 className="text-4xl font-bold mb-4  underline underline-offset-4 decoration-blue-500">
              Conference Venue
            </h1>
      ...
      <motion.section
        ...
        className="container mx-auto px-4 py-16"
      >
        <h1 className="text-4xl font-bold mb-4  underline underline-offset-4 decoration-blue-500 text-center">
          Location
        </h1>
